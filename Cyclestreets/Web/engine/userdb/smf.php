...
{
	var $parent;
	var $name	= "Simple Machines Forum 1.1.x";
    var $version = 100;
	...
	function init(&$parent)
	{
		...
		$this->parent->db_name = "memberName";
		$this->parent->db_password = "passwd";
		$this->parent->db_level = "ID_GROUP";
		$this->parent->db_email = "emailAddress";
		$this->parent->db_g_id = "ID_GROUP";
		$this->parent->db_g_title = "groupName";
