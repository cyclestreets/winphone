...
* Last Modified..: $Date: 2008-12-20 20:32:52 +0000 (Sat, 20 Dec 2008) $
* CVS Revision...: $Revision: 50 $
...
*/
	...
	function htmlMimeMail()
	{
        ...
        */
		...
		$this->smtp_params['host'] = ($CONFIG['smtphost'])?$CONFIG['smtphost']:"localhost";
		$this->smtp_params['port'] = ($CONFIG['smtpport'])?$CONFIG['smtpport']:25;
		$this->smtp_params['helo'] = $helo;
		$this->smtp_params['auth'] = false;
		$this->smtp_params['user'] = $CONFIG['smtpusername'];
		$this->smtp_params['pass'] = $CONFIG['smtppass'];
